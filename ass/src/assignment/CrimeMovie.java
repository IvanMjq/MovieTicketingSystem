...
public class CrimeMovie extends Movie {
    ...
    private final String genre = "Crime", ageAppropriateness = "PG-13(Some material may not be suitable for children under 13.)";
    private String movieDirector, mainCast, plotSummary;

    public CrimeMovie(String movieID, String movieTitle, String releaseDate, int movieDuration, double rating, String movieDirector, String mainCast, String plotSummary) {
